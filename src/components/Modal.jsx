...
export default function Modal({ children, heading}) {
  return createPortal(
    <div className="fixed top-[250px] md:top-[150px] md:scale-[0.8] flex h-[440px] w-[300px] flex-col items-center gap-3 justify-self-center rounded-2xl bg-white p-4 shadow-2xl">
