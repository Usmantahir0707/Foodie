...
export default function UserMenu({ userData, setUserMenu, setLocating, logout }) {
    ...
    <Overlay onClick={() => setUserMenu(false)}>
        ...
        {/* Main Section */}
      {
        section === 'main' && (
            <div>
           {/* Profile-Pic */}
        <div className="mt-6 h-[100px] w-[100px] cursor-pointer justify-self-center
        ">
          {userData.profilePic ? (
            <img
              className="h-full w-full flex-shrink-0 overflow-hidden rounded-[8px] object-center"
              src={userData.profilePic}
              alt=""
            />
          ) : (
            <i className="fa-solid fa-user h-full w-full self-start shadow-[0_0_10px_rgba(0,0,0,0.3)] rounded-[8px] bg-gray-300 p-2 text-[58px]"></i>
          )}
        </div>

        <div className="flex flex-col gap-4 justify-self-center">
          <h2 className="text-[22px] font-[500]">{userData.name}</h2>
          {/* Menu */}
          <ul className="text-[14px] text-[var(--primary-color)]">
            {/* vouchers */}
            <li onClick={()=> setSection('vouchers')} className="cursor-pointer p-0.5 px-2 hover:border-[0px_2px_0px_2px] active:border-[0px_2px_0px_2px]">
              <i className="fa-solid fa-ticket-simple"></i> Vouchers
            </li>
            {/* Fav */}
            <li onClick={()=> setSection('favourites')} className="cursor-pointer p-0.5 px-2 hover:border-[0px_2px_0px_2px] active:border-[0px_2px_0px_2px]">
            ...
            className="cursor-pointer p-0.5 px-2 hover:border-[0px_2px_0px_2px] active:border-[0px_2px_0px_2px]">
              <i className="fa-solid fa-map-location-dot"></i> Update Address
            </li>
            {/* Cam */}
            <li onClick={()=> setSection('picture')} className="cursor-pointer p-0.5 px-2 hover:border-[0px_2px_0px_2px] active:border-[0px_2px_0px_2px]">
              <i className="fa-solid fa-camera-retro"></i> Update Profile Pic
            </li>
            {/* password */}
            <li onClick={()=> setSection('password')} className="cursor-pointer p-0.5 px-4 hover:border-[0px_2px_0px_2px] active:border-[0px_2px_0px_2px]">
      ...
      {
        section === 'vouchers' && (
          <div className="p-2 pb-12 h-[400px] overflow-y-auto flex flex-col items-center">
            {/* Back Buttoon */}
            <div
            className="absolute self-baseline p-1 rounded justify-self-start cursor-pointer bg-gray-200"
            onClick={()=> setSection('main')}
            >
              <i className="fa-solid fa-angle-left text-[var(--primary-color)]"></i> Main
            </div>
             {/* title*/}
            <div className="mt-4">
               <h4 className="mt-2 text-[20px] font-[500]">My Vouchers</h4>
               <p className="text-[14px] text-gray-500">Grab your vouchers and start saving</p>
            </div>
           
           <div className="self-baseline px-2 flex w-full justify-between mt-6">
            <p>Total Vouchers: 2</p>
            <div className="flex gap-1 items-center cursor-pointer">
              <span>Add</span> 
              <i className="fa-solid fa-square-plus text-[22px] text-[var(--primary-color)]"></i>
            </div>
      ...
      {/* Favourites Section */}
      {
        section === 'favourites' && (
          <div className="p-2">
            {/* Back Buttoon */}
            <div
            className="absolute p-1 rounded justify-self-start cursor-pointer bg-gray-200"
            onClick={()=> setSection('main')}
            >
              <i className="fa-solid fa-angle-left text-[var(--primary-color)]"></i> Main
            </div>
            ...
            <div className="mt-4">
               ...
               <p className="text-[14px] text-gray-500">Your best picks, saved here</p>
            </div>
      ...
      {/* Picture Section */}
      {
        section === 'picture' && (
          <div className="p-2">
            ...
            <div className="mt-8 flex justify-center scale-[0.8]">
              {cameraActive ? (
                              <Camera
        ...
        section === 'password' && (
          <div className="p-2">
            ...
            <div className="mt-4">
               ...
               <p className="text-[14px] text-gray-500">Keep your account safe</p>
            </div>
